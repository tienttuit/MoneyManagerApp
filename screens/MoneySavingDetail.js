...
const SavingDetailScreen = (props) => {
  ...
  const CurrentScreen =
    currentState == "GOAL" ? (
      <GoalDeTail item={props.route.params} />
    ) : (
      <GoalRecord item={props.route.params} navigation={props.navigation} />
    );
  useLayoutEffect(() => {
        ...
        [
          ...
          },
          {
            ...
            onPress: () => {
              ...
              props.navigation.navigate("Chế độ tiết kiệm", {
                trigger: "true",
              });
            },
          },
      ...
      <View style={styles.headerBar}>
        <TouchableOpacity
          style={[
            ...
            {
              backgroundColor:
                currentState == "GOAL" ? "#F7FBFC" : "rgb(45,139, 126)",
            },
          ]}
        ...
        >
          <Text
            style={[
              styles.cate_text,
              { color: currentState == "GOAL" ? "rgb(45,139, 126)" : "white" },
            ]}
          >
            MỤC TIÊU
          </Text>
        ...
        <TouchableOpacity
          style={[
            ...
            {
              backgroundColor:
                currentState == "RECORD" ? "#F7FBFC" : "rgb(45,139, 126)",
            },
          ]}
        ...
        >
          <Text
            style={[
              styles.cate_text,
              {
                color: currentState == "RECORD" ? "rgb(45,139, 126)" : "white",
              },
            ]}
          >
            GIAO DỊCH{" "}
