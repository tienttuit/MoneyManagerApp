...
const TransactionScreen = (props) => {
  ...
  const [currentExpense, setCurrentExpense] = useState(
    displayedMoney ? displayedMoney.expenseValue : 0
  );
  const [currentIncome, setCurrentIncome] = useState(
    displayedMoney ? displayedMoney.incomeValue : 0
  );
      ...
      <SafeAreaView style={styles.headerBar}>
        ...
        <View>
          ...
          >
            {displayedMoney
              ? formatMoney(
                  displayedMoney.incomeValue - displayedMoney.expenseValue
                )
              : 0}{" "}
            VND
          </Text>
        ...
        <View>
          ...
          >
            ...
            <Text style={{ fontSize: FONTSIZE.header1, color: "white" }}>
              {displayedMoney ? formatMoney(displayedMoney.expenseValue) : 0}{" "}
              VND
            </Text>
          </View>
          ...
          >
            <TouchableOpacity
              style={styles.walletDetail}
              onPress={() =>
                props.navigation.navigate("Chi tiết ví", {
                  money: displayedMoney,
                })
              }
            >
              <Text
                style={{ color: "rgb(45,139, 126)", fontSize: FONTSIZE.small }}
              >
                Chi tiết ví
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              ...
              onPress={() => props.navigation.navigate("Giao dịch đã xóa")}
            >
              <Text
                style={{ color: "rgb(45,139, 126)", fontSize: FONTSIZE.small }}
              >
        ...
        {!isLoading ? (
          ...
          <FlatList
            contentContainerStyle={{
              paddingBottom: transactionList.length == 0 ? 100 : 300,
              width: "100%",
              flexGrow: 1,
            }}
